...
CREATE TYPE management_authorization AS ENUM ('MANAGE_MANAGERS', 'CREATE_USERS', 'UPDATE_USERS', 'DELETE_USERS', 'RESET_USER_TOKENS');

CREATE TABLE IF NOT EXISTS flare_manager (
                                             "id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                             "username" VARCHAR(64) NOT NULL,
    "password" VARCHAR(128) NOT NULL,
    "authorizations" MANAGEMENT_AUTHORIZATION[] NOT NULL,
